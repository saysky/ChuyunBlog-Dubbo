...
import com.example.blog.api.entity.Role;
import com.example.blog.api.entity.User;
import com.example.blog.api.entity.UserRoleRef;
import com.example.blog.api.enums.CommonParamsEnum;
import com.example.blog.api.enums.TrueFalseEnum;
import com.example.blog.api.enums.UserStatusEnum;
import com.example.blog.api.service.*;
import com.example.blog.api.util.Md5Util;
import com.example.blog.api.util.RegexUtil;
...
public class LoginController extends BaseController {
    ...
    @Reference(version = "1.0.0",
            application = "${dubbo.application.id}",
            interfaceName = "com.example.blog.api.service.MailService",
            check = false,
            timeout = 3000,
            retries = 0
    )
