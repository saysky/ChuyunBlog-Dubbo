...
import com.example.blog.service.mapper.CategoryMapper;
import com.example.blog.service.mapper.PostCategoryRefMapper;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public List<Category> findAll(QueryWrapper<Category> queryWrapper) {
        return categoryMapper.selectList(queryWrapper);
    }
}
